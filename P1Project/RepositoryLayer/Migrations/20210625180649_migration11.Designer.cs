...
namespace RepositoryLayer.Migrations
{
    ...
    [Migration("20210625180649_migration11")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModelsLibrary.CustomerModel", b =>
                {
                    ...
                    b.Property<string>("DefaultStoreLocation")
            ...
            modelBuilder.Entity("ModelsLibrary.OrderedItemsModel", b =>
                {
                    b.HasOne("ModelsLibrary.ItemsModel", "Item")
                        .WithMany("OrderedItems")
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ModelsLibrary.CustomerOrderModel", "CustomerOrder")
                        .WithMany("OrderedItems")
